  ...
  return <div className="min-h-screen bg-[#0b1f3a] px-5 py-10 text-white">
    <div className="mx-auto flex min-h-[80vh] max-w-md flex-col justify-center">
      ...
      <form onSubmit={submit} className="rounded-[2rem] bg-white p-5 text-slate-900 shadow-2xl">
        ...
        <input id="email" className="input" type="email" inputMode="email" autoComplete="username" value={email} onChange={e => setEmail(e.target.value)} placeholder="seu@email.com" required />
